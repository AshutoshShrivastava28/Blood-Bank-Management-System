...
<body>
  <?php include 'header.php'; ?>
        ...
        <div class="col-lg-5 col-md-5 col-sm-6 col-xs-7 mb-5">
          <div class="card rounded">
            <ul class="nav nav-tabs justify-content-center" style="padding: 20px">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#receivers" style="border: 1px solid black; font-weight:bold;text-decoration: none; color: black;">Receivers</a>
              </li>
            </ul>
    ...
    <a href="login.php" class="text-center mb-4" title="Click here" style="color: yellow; text-decoration: underline;">Already have account?</a>
</div>
</div>
</div>
</div>
