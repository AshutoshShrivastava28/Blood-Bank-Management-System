...
<body style="background-color: #e7d2b9;">
	...
	<table class="table table-responsive table-striped rounded mb-5 justofy-content-center" style="align-items: center; margin-left: 150px;">
		...
		<tr style="color: black;">
			...
			<td id="aon"><?php echo $row['status'];?></td>
...
<script type="text/javascript">
	let x = document.getElementById('aon').value;
	console.log(x);
	if(x == "Accepted"){
		x.style.color="green";
	}
